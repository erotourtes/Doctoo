...
export default function PopupDoctoo({
  ...
  return (
    <Popup open={popupIsOpen} onClose={closePopup}>
      ...
      <article
        className={`min-h-2/4 absolute left-1/2 top-1/2 flex w-3/4 -translate-x-1/2 -translate-y-1/2 transform flex-col rounded-xl bg-white p-12 ${modalFullClassName}`}
      >
        {/* Close icon */}
