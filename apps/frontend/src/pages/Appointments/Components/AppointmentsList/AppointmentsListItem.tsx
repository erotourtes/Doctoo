...
export default function AppointmentsListItem({ appointment, openModal }: AppointmentsListItemProps) {
  const { doctor, videoRecordKey, notes, status, paymentInvoiceKey, paymentReceiptKey, id } = appointment;
      ...
      >
        ...
        <div className='flex flex-col justify-between'>
          <div className='flex flex-col gap-x-2 self-end'>
            <AppointmentButtons componentName='listItem' status={status} appointmentId={id} />
          </div>
