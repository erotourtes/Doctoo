      ...
      <div className='p- relative z-20 flex h-full min-w-[500px] flex-col gap-7 rounded-xl bg-white p-12'>
        ...
        <form onSubmit={e => e.preventDefault()} className='flex w-full flex-col gap-7'>
          <div className='w-full'>
            <Input label='Name and surname' placeholder='John Smith' type='text' className='w-full' />

            <Input label='Email' placeholder='john.smith@gmail.com' type='text' className='w-full' />

            <div className='flex w-full'>
              {/* TODO: Add select input after it's ready */}
              <Input label='Phone' placeholder='060 612 12 07' type='text' className='w-full' />
            </div>
          </div>
